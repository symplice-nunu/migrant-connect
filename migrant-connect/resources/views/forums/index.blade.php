        ...
        @if($forums->count() > 0)
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($forums as $forum)
                    <div class="group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden transform hover:-translate-y-2 transition-all duration-300">
                        <!-- Card Header with Gradient -->
                        <div class="relative bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 px-8 py-6">
                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <div class="ml-4">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-200 border border-green-200 dark:border-green-700">
                        ...
                        <div class="p-8">
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-6">
                                <div class="text-center p-4 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border border-blue-100 dark:border-blue-800">
                                    ...
                                    <p class="text-lg font-bold text-gray-900 dark:text-white">{{ rand(5, 50) }}</p>
                                    <p class="text-xs text-gray-600 dark:text-gray-400 font-medium">Members</p>
                                </div>
                                <div class="text-center p-4 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-xl border border-indigo-100 dark:border-indigo-800">
                                    <div class="flex items-center justify-center w-10 h-10 bg-indigo-500 rounded-lg mx-auto mb-2">
                                        <i class="fas fa-comment text-white"></i>
                                    </div>
                                    <p class="text-lg font-bold text-gray-900 dark:text-white">{{ rand(10, 100) }}</p>
                                    <p class="text-xs text-gray-600 dark:text-gray-400 font-medium">Posts</p>
                                </div>
                            </div>
            ...
            <div class="mt-12 text-center">
                <div class="inline-flex items-center px-6 py-3 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
            ...
            <div class="text-center py-20">
                <div class="max-w-md mx-auto">
                    <div class="relative mb-8">
                        <div class="w-32 h-32 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-full flex items-center justify-center mx-auto shadow-xl">
