...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-3 py-2 border-b-2 border-teal-500 text-sm font-medium leading-5 text-teal-600  focus:outline-none transition duration-150 ease-in-out'
