    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="card card-hover animate-fade-in-up" style="animation-delay: {{ $loop->index * 0.1 }}s;">
            ...
            <div class="p-6">
                <div class="flex items-start justify-between mb-4">
                    <h3 class="text-xl font-bold text-gray-900 line-clamp-2">{{ $event->title }}</h3>
                </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <a href="{{ route('events.edit', $event->id) }}" class="inline-flex items-center p-3 text-gray-400 hover:text-blue-600 :text-blue-400 hover:bg-blue-50 :bg-blue-900/20 rounded-xl transition-all duration-200">
        ...
        <div class="col-span-full">
            <div class="text-center py-16">
                ...
                <p class="text-xl text-gray-600 mb-8 max-w-md mx-auto">Be the first to create an event and bring the community together!</p>
